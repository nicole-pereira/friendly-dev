...
const ProjectCard = ({ project }: { project: Project }) => {
  return (
    <Link
      ...
      <div className="bg-orange-300 border border-gray-700 rounded-lg overflow-hidden-shadow-sm transition hover:shadow-md">
        <img
          src={project.image}
          alt={project.title}
        ...
        <div className="p-5">
          ...
          <p className="text-sm text-orange-300-mb-2">{project.description}</p>
