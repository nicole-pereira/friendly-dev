const AboutPage = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-16 bg-orange-200">
      {/* Intro */}
      <div className="flex flex-col md:flex-row md:items-start items-center gap-10 mb-12">
        ...
        />
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Hey, I'm N 👋</h1>
      ...
      <ul className="flex flex-wrap gap-4 text-sm text-orange-200">
        {[
          "React",
          "Next.js",
          "Vue",
          ...
          <li key={tech} className="bg-orange-700 px-3 py-1 rounded-md">
            {tech}
          </li>
        ))}
      </ul>
